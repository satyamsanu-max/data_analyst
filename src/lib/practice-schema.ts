/**
 * The SQL practice dataset: schema + deterministic seed data.
 *
 * Pure — no driver, no connection. Both the local PGlite instance and the
 * hosted Postgres schema are built from exactly this SQL, so a query behaves
